...
KUBERNETES_KEYPAIR_NAME=${KUBERNETES_KEYPAIR_NAME:-k8s}
...
MINION_FLAVOR=${MINION_FLAVOR:-medium}
...
SWIFT_SERVER_URL=${SWIFT_SERVER_URL:-http://172.22.131.17:8080}
...
CREATE_IMAGE=${CREATE_IMAGE:-false} # use "true" for devstack

# Flag indicates if image should be downloaded
DOWNLOAD_IMAGE=${DOWNLOAD_IMAGE:-false}

# Image id which will be used for kubernetes stack
IMAGE_ID=${IMAGE_ID:-65cb9b41-09b2-402a-8920-a68fd00da809}
